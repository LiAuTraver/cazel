...
load("//bazel/third_party/bazel_skylib:transitive.bzl", "load_bazel_skylib_transitive_dependencies")
load("//bazel/third_party/rules_go:transitive.bzl", "load_rules_go_transitive_dependencies")
